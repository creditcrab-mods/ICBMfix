...
import icbm.sentry.packet.PacketHandlerTurret;
import icbm.sentry.packet.PacketTurret;
import icbm.sentry.platform.BlockTurretPlatform;
import icbm.sentry.terminal.TerminalCommandPacket;
import icbm.sentry.terminal.TerminalCommandPacketHandler;
import icbm.sentry.terminal.TerminalOutputPacket;
import icbm.sentry.terminal.TerminalOutputPacketHandler;
...
public class ICBMSentry extends MainBase {
    ...
    @SidedProxy(
        clientSide = "icbm.sentry.ClientProxy", serverSide = "icbm.sentry.CommonProxy"
    )
