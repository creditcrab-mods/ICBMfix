...
import icbm.contraption.block.BCamouflage;
import icbm.contraption.block.BConcrete;
import icbm.contraption.block.BGlassButton;
import icbm.contraption.block.BGlassPressurePlate;
import icbm.contraption.block.BGlassReinforced;
import icbm.contraption.block.BProximityDetector;
import icbm.contraption.block.BSpikes;
import icbm.contraption.block.IBConcrete;
...
public class ICBMContraption extends MainBase {
    ...
    @SidedProxy(
        clientSide = "icbm.contraption.ClientProxy", serverSide = "icbm.contraption.CommonProxy"
    )
